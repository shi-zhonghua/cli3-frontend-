<template>
    <div>
        <!-- <img :src="src" alt=""> -->
        <div style="background:#000; width:500px;">
            <vue-waterfall-easy :imgsArr="imgsArr" :imgWidth="120" @scrollLoadImg="fetchImgsData"></vue-waterfall-easy>
        </div>
    </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      ...
      src: require(`../assets/imgages/1.jpg`)
    };
  },
  methods: {
    initImgsArr(n, m) {
